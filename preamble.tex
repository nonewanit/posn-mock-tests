...
% --- ฟอนต์สำหรับ code block (Courier New) ---
% AutoFakeBold สังเคราะห์ตัวหนา เพราะ font มีเฉพาะน้ำหนักปกติ
\setmonofont[Path=../fonts/CourierNew/, AutoFakeBold=2.0]{cour.ttf}
